...
# Official 722E_4 sample highlights (text chips + KEY boxes) — pure yellow / orange / red
HEX_HIGHLIGHT_ADVISORY = "FFFF00"
HEX_HIGHLIGHT_WARNING = "FFA500"
HEX_HIGHLIGHT_MAJOR = "FF0000"
...
# Text / KEY chip fills matching TMA sample PDFs in Downloads/tma
...
# Alert level text color mapping — black words on filled tier chips (print-safe)
ALERT_TEXT_COLORS = {
    "MAJOR_WARNING": COLOR_BLACK,
    "WARNING": COLOR_BLACK,
