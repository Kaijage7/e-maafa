...
def shade_run(run, hex_color: str):
    """Apply a solid background fill to a text run (TMA yellow/orange/red chips).

    Matches official 722E_4 samples where ADVISORY / Impacts expected sit on
    a filled colour band with black text.
    """
    if not hex_color:
        return run
