...
@Component({
  ...
  styles: [`
    ...
    .pill { font-size: 0.75rem; font-weight: 800; border-radius: 7px; padding: 1px 6px; color: #1a1a1a; margin-left: auto; white-space: nowrap; }
    .xa-meta { font-size: 0.75rem; color: #475569; line-height: 1.45; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
    .xa-meta .k { color: #94a3b8; } .xa-types { margin-top: 4px; white-space: nowrap; overflow: hidden; }
    .tchip { display: inline-block; font-size: 0.75rem; font-weight: 700; background: #eef2f7; color: #334155; border-radius: 6px; padding: 1px 6px; margin: 0 3px 0 0; }
