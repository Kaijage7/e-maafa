...
@Component({
          ...
          <div class="et-row" [class.ret]="t.status==='returned'">
            ...
            @if (formFor() === t.id) {
              <div class="et-form">
                ...
                <textarea [ngModel]="fAction()" (ngModelChange)="fAction.set($event)" placeholder="Recommended measures or advisory to issue…"></textarea>
                <div class="et-fact">
  ...
  `,
    ...
    .et-sub { font-weight:500; font-size:0.8rem; color:#15803d; }
    ...
    .et-st { font-size:0.75rem; font-weight:800; text-transform:uppercase; border-radius:6px; padding:0.08rem 0.45rem; color:#475569; background:#e2e8f0; }
    ...
    .et-urg { font-size:0.75rem; font-weight:800; text-transform:uppercase; color:#9a3412; background:#ffedd5; border-radius:6px; padding:0.08rem 0.4rem; }
    .et-urg.imm { color:#fff; background:#dc2626; }
    .et-hz { font-size:0.8rem; font-weight:700; color:#334155; text-transform:capitalize; }
    .et-rg { font-size:0.8rem; color:#475569; }
    .et-ti { font-size:0.85rem; color:#1e293b; text-decoration:none; flex:1; min-width:140px; } .et-ti:hover { text-decoration:underline; }
    .et-tm { font-size:0.8rem; color:#94a3b8; }
    .et-meta { font-size:0.8rem; color:#64748b; margin-top:0.2rem; }
    .et-instr { font-size:0.85rem; color:#334155; background:#fff; border:1px dashed #cbd5e1; border-radius:7px; padding:0.3rem 0.5rem; margin-top:0.3rem; }
    .et-instr i, .et-retn i { color:#94a3b8; margin-right:4px; }
    .et-retn { font-size:0.85rem; color:#9f1239; margin-top:0.3rem; font-weight:600; }
    .et-sent { font-size:0.85rem; color:#166534; margin-top:0.35rem; } .et-sent i { margin-right:4px; }
    ...
    .et-ack { font-size:0.8rem; font-weight:700; border:1px solid #93c5fd; background:#fff; color:#1d4ed8; border-radius:7px; padding:0.25rem 0.7rem; cursor:pointer; }
    .et-resp { font-size:0.8rem; font-weight:800; border:none; background:#16a34a; color:#fff; border-radius:7px; padding:0.25rem 0.8rem; cursor:pointer; }
    .et-ack:hover, .et-resp:hover, .et-cancel:hover, .et-send:hover:not(:disabled) { filter: brightness(0.95); }
    ...
    .et-form label { display:block; font-size:0.75rem; font-weight:800; color:#94a3b8; text-transform:uppercase; margin:0.4rem 0 0.15rem; }
    ...
    .et-cancel { background:#fff; border:1px solid #cbd5e1; color:#475569; border-radius:7px; padding:0.35rem 0.9rem; font-weight:700; font-size:0.8rem; cursor:pointer; }
