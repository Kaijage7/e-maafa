...
@Component({
  ...
  `,
    ...
    .vsub { font-weight:500; font-size:0.75rem; color:#7c3aed; }
    .vrow { display:flex; align-items:center; gap:0.6rem; flex-wrap:wrap; padding:0.4rem 0; border-top:1px solid #ede9fe; }
    .vag { font-size:0.75rem; font-weight:800; color:#4c1d95; } .vhz { font-size:0.75rem; font-weight:700; color:#6d28d9; background:#ede9fe; border-radius:6px; padding:0.08rem 0.45rem; text-transform:capitalize; }
    .vrg { font-size:0.75rem; color:#475569; } .vti { font-size:0.8rem; color:#1e293b; text-decoration:none; flex:1; min-width:140px; } .vti:hover { text-decoration:underline; }
    .vgo { font-size:0.75rem; font-weight:700; color:#7c3aed; text-decoration:none; } .vgo:hover { text-decoration:underline; }
    .vdone { font-size:0.75rem; font-weight:700; border:1px solid #c4b5fd; background:#fff; color:#6d28d9; border-radius:7px; padding:0.2rem 0.55rem; cursor:pointer; }
    ...
    .flow { background:#eff6ff; border:1px solid #bfdbfe; border-radius:10px; padding:0.6rem 0.85rem; font-size:0.8rem; color:#1e3a8a; line-height:1.5; margin-bottom:0.8rem; }
    .flow .ep { display:block; margin-top:0.3rem; font-size:0.75rem; color:#475569; font-family:ui-monospace,monospace; }
    ...
    .rep-form label { display:block; font-size:0.75rem; font-weight:700; color:#94a3b8; text-transform:uppercase; margin-bottom:0.15rem; }
    ...
    .sc-sev { color:#fff; font-size:0.75rem; font-weight:800; text-transform:uppercase; padding:0.1rem 0.5rem; border-radius:20px; }
    .sc-haz { font-size:0.75rem; font-weight:700; color:var(--text-dark); text-transform:capitalize; }
    .sc-region { font-size:0.75rem; color:#475569; }
    .sc-src { font-size:0.75rem; font-weight:700; color:#64748b; background:rgba(0,0,0,0.05); padding:0.08rem 0.45rem; border-radius:6px; }
    .sc-src.official { background:rgba(5,150,105,0.12); color:#059669; }
    .sc-time { font-size:0.75rem; color:#94a3b8; margin-left:auto; }
    ...
    .sc-sum { font-size:0.8rem; color:var(--text-mid); margin-top:0.2rem; line-height:1.4; }
    .sc-actions { display:flex; flex-direction:column; gap:0.3rem; align-items:flex-end; flex-shrink:0; }
    .sc-act { border:1px solid var(--border); background:#fff; border-radius:7px; padding:0.25rem 0.6rem; font-size:0.78rem; font-weight:600; cursor:pointer; white-space:nowrap; }
    ...
    .sc-status { font-size:0.75rem; font-weight:700; color:#64748b; text-transform:capitalize; }
    .sc-status.disp { color:#7c3aed; }
    .sc-ref { font-size:0.75rem; font-weight:700; color:#0369a1; text-decoration:none; } .sc-ref:hover { text-decoration:underline; }
    ...
    .vurg { font-size:0.75rem; font-weight:800; color:#9a3412; background:#ffedd5; border-radius:6px; padding:0.08rem 0.45rem; text-transform:uppercase; }
    .vurg.imm { color:#fff; background:#dc2626; }
    .vst { font-size:0.75rem; font-weight:800; text-transform:capitalize; color:#475569; background:#f1f5f9; border-radius:6px; padding:0.08rem 0.45rem; }
    ...
    .vrev { font-size:0.78rem; font-weight:800; border:none; border-radius:7px; padding:0.22rem 0.6rem; cursor:pointer; display:inline-flex; align-items:center; gap:5px; }
    ...
    .vresp { font-size:0.75rem; color:#374151; padding:0.05rem 0.5rem 0.35rem; line-height:1.4; } .vresp i { color:#6d28d9; }
    ...
    .dm-card { background:#fff; border-radius:12px; padding:1.1rem 1.2rem; width:440px; max-width:100%; box-shadow:0 20px 50px rgba(0,0,0,0.3); max-height:90vh; overflow:auto; }
    ...
    .dm-card label { display:block; font-size:0.75rem; font-weight:800; color:#94a3b8; text-transform:uppercase; letter-spacing:0.02em; margin:0.7rem 0 0.2rem; }
    ...
    .dm-hint { font-size:0.75rem; color:#6d28d9; margin-top:0.35rem; display:flex; align-items:center; gap:5px; }
