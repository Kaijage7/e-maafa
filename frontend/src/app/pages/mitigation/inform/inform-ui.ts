...
export const INFORM_STYLES = `
  ...
  .field label { font-size: 0.75rem; font-weight: 700; color: var(--text-mid, #475569); text-transform: uppercase; letter-spacing: .04em; }
  ...
  .pill { font-size: 0.75rem; font-weight: 700; padding: .1rem .5rem; border-radius: 999px; background: #eef2ff; color: #3730a3; }
